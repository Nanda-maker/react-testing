...
describe("OrderStatusSelector", () => {
  const renderComponent = () => {
    ...
    return {
      ...
      getOptions: () => screen.findAllByRole("option"), // this will appear after rendering components - lazy evaluation
  ...
  it("should render correct statuses", async () => {
    ...
    // this will run after user click then options will show.
